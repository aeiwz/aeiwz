...
I'm a **Data Scientist** and **Bioinformatics Researcher** passionate about leveraging machine learning and computational methods to solve complex biological and medical problems. With a strong foundation in both computer science and life sciences, I bridge the gap between data and discovery.

### 🔬 What I Do
- **Bioinformatics & Computational Biology**: Analyzing genomic data, microbiome studies, and metabolomics
- **Machine Learning & AI**: Building predictive models with TensorFlow, PyTorch, and scikit-learn
- **Data Analysis & Visualization**: Transforming complex datasets into actionable insights using Python and R
- **Research & Publications**: Contributing to peer-reviewed scientific literature in cancer research and cardiovascular studies
...
I'm always open to interesting conversations, collaboration opportunities, and knowledge sharing. Feel free to reach out through any of the platforms below:
...
I'm actively involved in scientific research at the intersection of bioinformatics, data science, and medical sciences. My work focuses on leveraging computational methods to advance our understanding of disease mechanisms and improve patient outcomes.

### 📖 Recent Publications

| Year | Title | Journal | Links |
|------|-------|---------|-------|
| **2025** | Distinct Gut Microbiota Profiles Associated with Advanced Hepatocellular Carcinoma in a Thai Cohort | *Cancers* 17(17):2915 | [DOI](https://doi.org/10.3390/cancers17172915) |
| **2024** | Comparative Analysis of Metabolomic Responses in On-Pump and Off-Pump Coronary Artery Bypass Grafting | *Ann. Thorac. Cardiovasc. Surg.* 30(1):24-00126 | [DOI](https://doi.org/10.5761/atcs.oa.24-00126) |
| **2022** | Antioxidant Activity of Mustard Green and Thai Rat-tailed Radish Grown from Cold Plasma Treated Seeds | *Notulae Botanicae Horti Agrobotanici Cluj-Napoca* 50(2):12751 | [DOI](https://doi.org/10.15835/nbha50212751) |

<details>
  <summary><b>View Full Citations</b></summary>
  <br/>

**1. Gut Microbiota in Hepatocellular Carcinoma (2025)**
> Charoenthanadhol, T., Phetcharaburanin, J., **Bubpamala, T.**, Sookprasert, A., Chindaprasirt, J., Sanlung, T., Watcharenwong, P., Putraveephong, S., & Wirasorn, K. (2025). Distinct Gut Microbiota Profiles Associated with Advanced Hepatocellular Carcinoma in a Thai Cohort: A 16S rRNA Sequencing Study. *Cancers*, 17(17), 2915. https://doi.org/10.3390/cancers17172915

**2. Metabolomic Analysis in Cardiac Surgery (2024)**
> Karunasumetta, C., Tourthong, W., Mala, R., Chatgasem, C., **Bubpamala, T.**, Punchai, S., & Sawanyawisuth, K. (2024). Comparative Analysis of Metabolomic Responses in On-Pump and Off-Pump Coronary Artery Bypass Grafting. *Annals of Thoracic and Cardiovascular Surgery*, 30(1), 24-00126. https://doi.org/10.5761/atcs.oa.24-00126

**3. Cold Plasma Treatment Effects on Plants (2022)**
> MATRA, K., SAENGHA, W., KARIRAT, T., NAKHOWONG, K., PATTANU, P., KITKAYUN, P., **BUBPAMALA, T.**, BURANRAT, B., KATISART, T., & LUANG-IN, V. (2022). Antioxidant activity of mustard green and Thai rat-tailed radish grown from cold plasma treated seeds and their anticancer efficacy against A549 lung cancer cells. *Notulae Botanicae Horti Agrobotanici Cluj-Napoca*, 50(2), 12751. https://doi.org/10.15835/nbha50212751
...
<p align="center">
  <sub>⭐️ If you find my work interesting, consider giving a star to my repositories!</sub>
</p>
